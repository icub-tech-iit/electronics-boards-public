...
int ADC_value[6];                         /* Last converted value             */
...
void ADC_Init (void) {
  ...
  ADC1->SMPR2   |= ( 5 <<  0);         	  /* sample time channel 0  55,5 cyc. */
	ADC1->SMPR2   |= ( 5 <<  3);         	  /* sample time channel 1  55,5 cyc. */
	ADC1->SMPR2   |= ( 5 <<  6);						/* sample time channel 2  55,5 cyc. */
	ADC1->SMPR2   |= ( 5 <<  9);         	  /* sample time channel 3  55,5 cyc. */
	ADC1->SMPR2   |= ( 5 << 12);         	  /* sample time channel 4  55,5 cyc. */
	ADC1->SMPR2   |= ( 5 << 15);						/* sample time channel 5  55,5 cyc. */

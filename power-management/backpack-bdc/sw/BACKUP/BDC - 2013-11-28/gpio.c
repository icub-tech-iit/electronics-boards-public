...
void GPIO_Init (void) {
	...
	GPIOA->CRL   |= 0x00000008;		// PA0		INPUT			HSM_IMON
	GPIOA->CRL   |= 0x00000080;		// PA1		INPUT			IMON_V12motor
	GPIOA->CRL   |= 0x00000800;		// PA2		INPUT			IMON_V12board
	GPIOA->CRL   |= 0x00008000;		// PA3		INPUT			VBATTMON
	GPIOA->CRL   |= 0x00080000;		// PA4		INPUT			V12motor_MON
	GPIOA->CRL   |= 0x00800000;		// PA5		INPUT			V12board_MON

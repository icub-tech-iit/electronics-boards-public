 ...
 * Author : Double Jay
 * adding features:
 * 	- allow around the clock count for motor encoder (not anymore just positive count)
 */
 ...
 * Author : Double Jay
 * adding features:
 *  - see voltage in Brushless motor
 */
...
{		
	...
	oscConfig();
	SetupPorts();   //setup UART,SPI,ADC,screen, etc...
...
//PROVA PER MANDARE SU SCHERMO IMAGINE DELLA SCHEDA SD//////////
...
//        wait_ms(200);
//    }
//    // iCub1 1.0 generated 14/11/2016 15:24:47
//    media_SetAdd(iiCub1H, iiCub1L);      // point to the iCub1 image
//    media_Image(0, 0);
//
//
...
//			//		putstr(DATA2SCREEN);
//			//		putstr("  ");
//					ratio = (1.0*ADC_V)/HALF_RANGE;
//					percent = ratio*100.0;// * 100.0;
//					txt_MoveCursor(7,0);
//					txt_FGcolour(BLUE);
//					putstr("Percentage: ");
...
//					putstr(DATA2SCREEN);
//					putstr("    ");
//                    disection=(int)((0xEFFF * ratio * 12/48));
//					set_PWM[1]=(char)(disection>>8);
//					set_PWM[0]=(char) (disection);
//                    txt_MoveCursor(9,0);
//					txt_FGcolour(GREEN);
//					putstr("voltage:    ");
//					sprintf(DATA2SCREEN,"%.2f",ratio*12);		
//					txt_MoveCursor(9,12);
//					putstr(DATA2SCREEN);
//					putstr("    ");
//	
